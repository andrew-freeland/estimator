...
import { pgContractorProfileRepository } from "./pg/repositories/contractor-profile-repository.pg";
...
export const contractorProfileRepository = pgContractorProfileRepository;
