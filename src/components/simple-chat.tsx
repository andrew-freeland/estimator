  ...
  return (
    <div className={cn("flex flex-col h-full max-w-4xl mx-auto", className)}>
      ...
      <div className="p-4 border-b bg-gray-50">
        ...
        <p className="text-sm text-gray-600">Ask me about construction costs, estimates, and project planning</p>
      </div>
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        {messages.length === 0 && (
          <div className="text-center text-gray-500 py-8">
            ...
            <p className="text-sm mt-2">Try asking: &quot;What&apos;s the cost of framing a 2000 sq ft house?&quot;</p>
          </div>
        )}
      ...
      <div className="border-t p-4 bg-white">
        <form onSubmit={handleSubmit} className="flex gap-2">
          <input
            ...
            placeholder="Ask about construction estimates, costs, or project planning..."
